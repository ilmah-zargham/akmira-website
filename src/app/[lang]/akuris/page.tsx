...
export default async function AkurisPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen min-h-[100svh] flex flex-col justify-between bg-hero-premium text-white pt-20 pb-12 overflow-hidden">
        ...
        <div className="flex-grow flex items-center w-full relative z-10 py-4 md:py-6">
          <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full">
            {/* Left Text */}
            <div className="lg:col-span-7 space-y-6">
              <ScrollReveal delay={0.1}>
                ...
                <div className="inline-flex items-center space-x-2.5 text-xs font-semibold tracking-widest text-cyan uppercase font-heading">
                  ...
                  <span>{dict.akuris.hero.eyebrow}</span>
                </div>
              </ScrollReveal>

              {/* Redesigned 2-Line Gradient Heading */}
              <ScrollReveal delay={0.2}>
                <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight">
                  <span className="block text-white">
                    {dict.akuris.hero.titleLine1}
                  </span>
                  <span className="block bg-gradient-to-r from-cyan to-violet bg-clip-text text-transparent">
                    {dict.akuris.hero.titleLine2}
                  </span>
                </h1>
              </ScrollReveal>
            ...
            {/* Right Animated Ear canal scan visual */}
        ...
        {/* Scroll indicator at the bottom center of the hero */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-1 z-20 pointer-events-none opacity-85 animate-gentle-bounce">
